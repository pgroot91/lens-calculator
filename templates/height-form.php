<section class="wplc_height_calculator">
    <h2><?php _e( 'Berekening naar hoogte object', 'lens-calculator'); ?></h2>
    <p><?php _e('Het berekenen van het juiste brandpunt van de lens ten opzichte van de hoogte en de afstand van het bewaakte gebied.', 'lens-calculator'); ?></p>
    <?php do_action( 'wplc_before_height_form' ); ?>
    <form id="wpcl-form" name="hoogte" autocomplete="off">
        ...
        <div id="btn-container">
            <div></div>
            <div class="btn-group">
                <input class="button" onclick="computeHeightForm(this.form)" type="button"
    ...
    <?php do_action( 'wplc_after_height_form' ); ?>
</section>